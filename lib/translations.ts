...
export const translations = {
  it: {
    ...
    fileTypeNotAllowed: 'Formato file non supportato. Sono consentiti solo JPG, PNG, WebP, GIF, PDF, TXT, Markdown e CSV.',
  ...
  en: {
    ...
    fileTypeNotAllowed: 'Unsupported file format. Only JPG, PNG, WebP, GIF, PDF, TXT, Markdown, and CSV are allowed.',
